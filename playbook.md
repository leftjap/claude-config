...
- 3/25: B-10 스와이프 뒤로가기 3건 수정. iOS 네이티브 에지 스와이프 경합 해소(touchstart preventDefault), 설정→운동 peek 화면 분기(_peekEl), 하단 버튼 safe-area 과잉여백 수정, 스와이프 취소 시 peekEl display 복원.
